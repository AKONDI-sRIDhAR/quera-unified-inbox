...
export const MagicBento = ({
  ...
  starCount = DEFAULT_PARTICLE_COUNT,
}: MagicBentoProps) => {
  ...
  useEffect(() => {
    if (!containerRef.current || !enableStars) return;
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen overflow-hidden magic-bento-wrapper">
      {enableSpotlight && (
        <div
          ref={spotlightRef}
          className="pointer-events-none absolute inset-0 z-10 global-spotlight"
        />
      )}
